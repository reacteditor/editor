...
For new slots, you don't need to do anything. If you're migrating existing DropZones to slots, you will need to migrate your the data accordingly. Frontend provides the [`migrate()` helper](/docs/api-reference/functions/migrate) to help with this:
