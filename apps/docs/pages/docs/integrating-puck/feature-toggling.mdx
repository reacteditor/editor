...
Feature toggling is enabled by React Editor's [Permissions API](/docs/api-reference/permissions). This enables you to toggle behavior like:
...
Toggling features across the entire React Editor instance can be done with global permissions. These can be set by the [`permissions` prop](/docs/api-reference/components/editor#permissions) on the React Editor component:
...
- [Global `permissions` prop API reference](/docs/api-reference/components/editor#permissions)
