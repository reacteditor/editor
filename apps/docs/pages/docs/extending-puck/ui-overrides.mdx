...
Overrides allow you to change how Puck renders its default interface. It can be used with or without [composition](/docs/extending-editor/composition).
...
Here's an example that also leverage the [internal Puck API](/docs/extending-editor/internal-editor-api) to replace the default publish button with a custom one:
