...
- [`tailwind-cdn`](https://github.com/frontend-inc/frontend-visual-editor/tree/main/packages/plugin-tailwind-cdn): Inject the Tailwind v4 browser CDN into the Frontend iframe.
