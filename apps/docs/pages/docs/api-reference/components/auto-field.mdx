...
import { AutoField } from "@/editor";

# \<AutoField\>

Render a React Editor field based on a [Field](/docs/api-reference/fields) object. Use this when building [custom fields](/docs/extending-editor/custom-fields) that need to use React Editor-style fields internally.
