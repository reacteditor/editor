...
Render a Puck field based on a [Field](/docs/api-reference/fields) object. Use this when building [custom fields](/docs/extending-editor/custom-fields) that need to use Puck-style fields internally.
...
```tsx {1,4} copy
import { Autofield } from "@editoreditor/core";
