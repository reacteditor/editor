...
import { Puck, Drawer } from "@/editor";

# \<Drawer\>

A list of items that can be dragged into a [`<Puck.Preview>`](editor-preview). Used for composing custom Puck UIs.
...
import { Puck, Drawer } from "@editoreditor/core";
