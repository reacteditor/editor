...
import { RichTextMenu } from "@/editor";
...
The icon to render for the control, as a React node. React Editor uses [lucide-react](https://lucide.dev/guide/packages/lucide-react) internally.
