...
An object describing render functions to override the default Frontend interface.
...
- [`editor`](overrides/editor): Override the Frontend children. This is the equivalent of passing in [`children`](/docs/api-reference/components/editor#children) to the [`<Editor>`](/docs/api-reference/components/editor) component.
