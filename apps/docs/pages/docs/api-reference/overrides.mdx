...
- [`editor`](overrides/editor): Override the Puck children. This is the equivalent of passing in [`children`](/docs/api-reference/components/editor#children) to the [`<Puck>`](/docs/api-reference/components/editor) component.
