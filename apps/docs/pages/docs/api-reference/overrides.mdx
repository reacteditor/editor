...
An object describing render functions to override the default React Editor interface.
...
- [`editor`](overrides/editor): Override the React Editor children. This is the equivalent of passing in [`children`](/docs/api-reference/components/editor#children) to the [`<Editor>`](/docs/api-reference/components/editor) component.
