...
`EditorApi` exposes Frontend's internals to enable extension and modification to Frontend's core behavior. It can be accessed by the [`useEditor`](/docs/api-reference/functions/use-editor) and [`useGetEditor`](/docs/api-reference/functions/use-get-editor) hooks.
...
The current [application state](/docs/api-reference/data-model/app-state) for this Frontend instance.
...
Execute an [action](/docs/api-reference/actions) to mutate the Frontend [application state](/docs/api-reference/data-model/app-state).
