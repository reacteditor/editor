...
A plugin is an extension that enhances the capabilities of React Editor.
...
Override the render functions for specific portions of the React Editor UI. Implements the [`overrides` API](/docs/api-reference/overrides).
