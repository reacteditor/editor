...
A plugin is an extension that enhances the capabilities of Frontend.
...
Override the render functions for specific portions of the Frontend UI. Implements the [`overrides` API](/docs/api-reference/overrides).
