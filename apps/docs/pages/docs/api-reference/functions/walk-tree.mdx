...
```tsx
import { walkTree } from "@frontendai/react-editor";
...
A Frontend [config](/docs/api-reference/configuration/config) object, used to determine which components contain slots.
