...
```tsx
import { walkTree } from "@reacteditor/core";
...
A React Editor [config](/docs/api-reference/configuration/config) object, used to determine which components contain slots.
