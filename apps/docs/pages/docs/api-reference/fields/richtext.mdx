import { Editor, RichTextMenu } from "@/editor";
...
The Rich Text field is built with [Tiptap](https://tiptap.dev). Configure React Editor's [included Tiptap extensions](#included-extensions) to modify editing behaviour.
...
import { RichTextMenu } from "@reacteditor/core";
...
The Tiptap [Editor Instance](https://tiptap.dev/docs/editor/api/editor). Use this to implement custom controls based on React Editor's [included extensions](#included-extensions), and additional extensions provided by [`tiptap.extensions`](#tiptapextensions).
