...
The Rich Text field is built with [Tiptap](https://tiptap.dev). Configure Frontend's [included Tiptap extensions](#included-extensions) to modify editing behaviour.
...
import { RichTextMenu } from "@frontendai/react-editor";
...
The Tiptap [Editor Instance](https://tiptap.dev/docs/editor/api/editor). Use this to implement custom controls based on Frontend's [included extensions](#included-extensions), and additional extensions provided by [`tiptap.extensions`](#tiptapextensions).
