...
The main configuration object describing what Frontend can render.
...
An object describing the components available to Frontend. Each component definition implements the [`ComponentConfig` API](/docs/api-reference/configuration/component-config).
