...
The main configuration object describing what React Editor can render.
...
An object describing the components available to React Editor. Each component definition implements the [`ComponentConfig` API](/docs/api-reference/configuration/component-config).
