...
Permissions enable the [toggling of Puck features](/docs/integrating-editor/feature-toggling). There are three types of permissions:
...
Custom permissions enable you to control your own functionality when [extending Puck](/docs/extending-editor/composition).
