...
Permissions enable the [toggling of Frontend features](/docs/integrating-editor/feature-toggling). There are three types of permissions:

1. **Global permissions** are shared across the entire Frontend application. Controlled via the `permissions` prop on the `<Editor>` component.
...
Custom permissions enable you to control your own functionality when [extending Frontend](/docs/extending-editor/composition).
