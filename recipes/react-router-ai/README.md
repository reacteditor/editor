...
The `react-router-ai` recipe showcases one of the most powerful ways to combine Frontend and [Frontend AI](https://editoreditor.com/docs/ai/overview): providing an authoring tool with AI page generation capabilities for any route in your React Router app.
